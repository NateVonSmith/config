...
function fromFetch(input, init) {
    return new (Observable_1.Observable.bind.apply(Observable_1.Observable, [void 0].concat([function (subscriber) {
        ...
        if (init) {
            ...
            if (init.signal) {
                if (init.signal.aborted) {
                    ...
                    var outerSignalHandler = function () {
                        if (!signal.aborted) {
                            controller.abort();
                        }
                    };
                    outerSignal.addEventListener('abort', outerSignalHandler);
                    subscription.add(function () { return outerSignal.removeEventListener('abort', outerSignalHandler); });
                }
            }
